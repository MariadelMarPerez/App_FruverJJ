        ...
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8"> 
            ...
            <div class="bg-gradient-to-r from-blue-500 to-blue-700 text-white rounded-lg shadow-lg mb-6">
                <div class="p-6">
                    ...
                    <div>
                        <h2 class="text-2xl font-bold">Registrar Nuevo Proveedor</h2>
                        <p class="text-blue-100 text-sm mt-1">Añade un nuevo proveedor al catálogo.</p>
                    </div>
                </div>
            </div>
            {{-- ===== FIN: BANNER ===== --}}
            ...
            <div class="mt-6 bg-blue-50 border border-blue-200 rounded-lg p-4">
                <div class="flex items-start">
                    ...
                    <div>
                        <h4 class="text-sm font-semibold text-blue-800">Consejos para registrar proveedores</h4>
                        <ul class="list-disc list-inside mt-2 text-sm text-blue-700 space-y-1">
                            <li>Asegúrate de que el nombre del proveedor sea único.</li>
                            <li>El teléfono es opcional pero recomendado para contacto.</li>
                            <li>Podrás editar esta información más tarde si es necesario.</li>
                        </ul>
                    </div>
                </div>
            </div>
